...
class QuizResultsViewModelFactory(private val score: Int, private val repository: QuizResultRespository) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(QuizResultsViewModel::class.java))
            return QuizResultsViewModel(score, repository) as T
